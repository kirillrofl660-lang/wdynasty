...
const DEFAULT_TIMELINE = [
  { year: 'Старт',   event: 'Команда бывших коллег запускает собственную студию.' },
  { year: 'Фокус',   event: 'Специализация на 1С-Битрикс и заказной веб-разработке.' },
  { year: 'Рост',    event: 'Добавили Laravel + React и сложные веб-сервисы.' },
  { year: 'DevOps',  event: 'Docker, CI/CD и поддержка проектов в продакшене.' },
  { year: 'Сегодня', event: 'Полный цикл — от дизайна до деплоя и сопровождения.' },
]

const DEFAULT_PARAGRAPHS = [
  'WebDynasty собрали разработчики и менеджеры, которые до этого несколько лет вместе вели проекты в другой компании. Решили запустить своё — чтобы строить процессы так, как считаем правильным.',
  'Сейчас в команде 6 человек: менеджеры, которые ведут проект и переводят задачи бизнеса на язык разработки, и разработчики с опытом в 1С-Битрикс и веб-сервисах. Небольшой состав — это сознательный выбор: меньше бюрократии и потерь в коммуникации.',
...
export default async function TeamPage() {
  ...
  const historyHeading  = page?.historyHeading ?? 'Вышли из одной компании и собрали студию со своими процессами'
